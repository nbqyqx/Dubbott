package com.tops001.dubbott.test.validation.tool.listener;
...
public class RestServletRequestListener implements ServletRequestListener {
	...
	public void requestInitialized(ServletRequestEvent sre) {
		/* you can do some thing to initialize your resources */
	}
